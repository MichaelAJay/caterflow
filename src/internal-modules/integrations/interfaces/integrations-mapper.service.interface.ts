import { IntegrationTemplateWithRequirements } from 'src/internal-modules/external-handlers/db-handlers/catering-company-db-handler/types/return/integration-template-with-requirements.return.type';
